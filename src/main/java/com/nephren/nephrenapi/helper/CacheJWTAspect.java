...
import com.nephren.nephrenapi.helper.util.AspectUtil;
import com.nephren.nephrenapi.helper.util.JWTUtil;
import com.nephren.nephrenapi.servicesImpl.RedisServiceImpl;
...
public class CacheJWTAspect {
  ...
  @Around("@annotation(com.nephren.nephrenapi.helper.annotation.CacheJWT)")
